...
<div id="content">
			<div class="movie_menu">
				...
				<div class="hot_swtich">
                  <router-link tag="div" class="hot_item" to="/movie/nowplay">正在热映</router-link>
                  <router-link tag="div" class="hot_item" to="/movie/comesoon">即将上映</router-link>
				</div>
                <router-link tag="div" class="search_entry" to="/movie/search"><i class="iconfont icon-sousuo"></i></router-link>
...
<TabBar/> <router-view name="detail"/>
</div>
</template>
<script>
